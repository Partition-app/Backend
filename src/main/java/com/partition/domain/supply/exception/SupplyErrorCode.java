...
public enum SupplyErrorCode implements BaseErrorCode {
    ...
    SUPPLY_5003(409, "이미 정산요청된 구매 기록이 포함되어 있습니다."),
    SUPPLY_5004(400, "하우스 멤버가 아닌 유저가 포함되어 있습니다."),
    SUPPLY_5005(400, "정산 대상 멤버를 선택해주세요."),
    SUPPLY_5006(409, "이미 정산완료된 구매 기록이 포함되어 있습니다."),
    SUPPLY_5007(404, "존재하지 않는 정산 내역입니다."),
    SUPPLY_5008(409, "이미 정산완료된 내역입니다."),
    SUPPLY_5009(400, "정산요청 상태의 내역만 완료 처리할 수 있습니다."),
    SUPPLY_5010(403, "해당 정산에 대한 권한이 없습니다."),
    SUPPLY_5011(409, "정산 요청 중인 구매 기록은 상태를 변경할 수 없습니다."),
    SUPPLY_5012(403, "해당 구매 기록에 대한 권한이 없습니다."),
