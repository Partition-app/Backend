...
public enum SupplySubCategoryType {
    ...
    KITCHEN_ETC("기타", SupplyCategoryType.KITCHEN),
    ...
    BATHROOM_ETC("기타", SupplyCategoryType.BATHROOM),
    ...
    CLEANING_ETC("기타", SupplyCategoryType.CLEANING),
    ...
    HYGIENE_ETC("기타", SupplyCategoryType.HYGIENE),
    ...
    GROCERY_ETC("기타", SupplyCategoryType.GROCERY),
    POWER_STRIP("멀티탭", SupplyCategoryType.LIVING),
    TISSUE_BOX("각티슈", SupplyCategoryType.LIVING),
    AIR_FRESHENER_ETC("방향제", SupplyCategoryType.LIVING),
    FLUORESCENT_LAMP("형광등", SupplyCategoryType.LIVING),
    BATTERY("건전지", SupplyCategoryType.LIVING),
    MOSQUITO_REPELLENT("모기약", SupplyCategoryType.LIVING),
    ELECTRIC_FLY_SWATTER("전기파리채", SupplyCategoryType.LIVING),
    LIVING_ETC("기타", SupplyCategoryType.LIVING),
    ETC("기타", SupplyCategoryType.ETC);
